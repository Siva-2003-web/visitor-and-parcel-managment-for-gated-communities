...
export const createVisitor = async (
  ...
  const [result] = await db.execute<ResultSetHeader>(
    `INSERT INTO visitors_parcels (
       resident_id, full_name, phone, purpose, status, expected_at, checked_out_at, record_type
     ) VALUES (:resident_id, :full_name, :phone, :purpose, :status, :expected_at, :checked_out_at, 'visitor')`,
    {
...
export const getVisitors = async (
  ...
  const [rows] = await db.query<VisitorRow[]>(
    `SELECT id, resident_id, full_name, phone, purpose, status, expected_at, arrived_at, checked_in_at, checked_out_at, created_at, updated_at
